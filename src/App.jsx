...
const galleryImages = [
  { src: assetPath('images/gallery/trainer-01.png'), alt: 'ספיר מדר במהלך אימון אישי' },
  { src: assetPath('images/gallery/trainer-02.png'), alt: 'אימון כושר פונקציונאלי עם ספיר מדר' },
  { src: assetPath('images/gallery/trainer-03.png'), alt: 'אימון פילאטיס פונקציונאלי' },
  { src: assetPath('images/gallery/trainer-04.png'), alt: "אימון קרוספיט ונינג'ה" },
]
